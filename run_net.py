...
def train(data_folder=".", model_folder="runs", net_type='BasicUnet'):
...
def infer(data_folder=".", model_folder="runs", prediction_folder="output", net_type='BasicUnet'):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--net_type", default="BasicUnet", type=str, help="net type")
